...
module.exports.list = (req, res, next) => {
    ...
    if(filters != null) {
        url = `https://${process.env.VC}/rest/vcenter/datastore${filters}`;
    }
    else {
        url = `https://${process.env.VC}/rest/vcenter/datastore`;
    }
    my_http_options = {
        method: 'get',
        url: url,
...
module.exports.details = (req, res, next) => {
    ...
    my_http_options = {
        method: 'get',
        url: `https://${process.env.VC}/rest/vcenter/datastore/${id}`,
        withCredentials: true,
        headers: req.headers,
        responseType: 'json',
        responseEncoding: 'utf8',
